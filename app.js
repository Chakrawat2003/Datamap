...
if ($("s11Save")) {
  ...
  $("s11Save").onclick = async () => {
    ...
    try {
      ...
      toast(
        "บันทึก 7-Eleven ลง Supabase แล้ว"
      );
  ...
  $("cjSave").onclick =
    async () => {
      ...
      try {
        ...
        toast(
          "บันทึก CJ MORE ลง Supabase แล้ว"
        );
    ...
    .on(
      ...
      async (payload) => {
        ...
        try {
          ...
          // ถ้ามี popup/modal เปิดอยู่ ให้ update ใหม่ด้วย
          if (typeof s11Update === "function") {
            s11Update();
          }
        } catch (err) {
