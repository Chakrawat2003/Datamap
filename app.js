...
map.getPane("pinmapBoundaryPane").style.zIndex = "320";
map.getPane("pinmapBoundaryPane").style.pointerEvents = "none";

map.createPane("pinmapDolPane");
map.getPane("pinmapDolPane").style.zIndex = "330";
map.getPane("pinmapDolPane").style.pointerEvents = "none";

if (map.getPane("markerPane")) map.getPane("markerPane").style.zIndex = "700";
if (map.getPane("tooltipPane")) map.getPane("tooltipPane").style.zIndex = "710";
if (map.getPane("popupPane")) map.getPane("popupPane").style.zIndex = "720";
...
(function setupRequestedAdditions(){
  ...
  roadCanvas.style.cssText = "position:absolute;left:0;top:0;pointer-events:none;z-index:390;display:none;";
