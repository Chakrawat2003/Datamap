PinMap - Password Reset OTP patch
=================================
...
แนวทางใหม่:
กด "ลืมรหัสผ่าน?" -> ส่ง Recovery OTP -> กรอกรหัส OTP 6 หลักจากอีเมล Outlook -> ตั้งรหัสผ่านใหม่
...
เปลี่ยนเนื้อหา Recovery email ให้ส่ง "รหัส OTP" แทนปุ่ม/ลิงก์รีเซ็ตรหัสผ่าน เพื่อป้องกัน Outlook/Microsoft Safe Links เปิดลิงก์ใช้ครั้งเดียวอัตโนมัติ
...
หมายเหตุ:
- โค้ดจะเรียก resetPasswordForEmail() เพื่อสร้าง recovery OTP
